...
public class ListSEService {
    ...
    public ListSEService() {
        kids = new ListSE();
        kids.add(new Kid("1","juan",(byte)18,'M'));
        kids.add(new Kid("2","ana",(byte)18,'F'));
        kids.add(new Kid("3","juana",(byte)18,'F'));
        kids.add(new Kid("4","carlos",(byte)18,'M'));
        kids.add(new Kid("5","mariana",(byte)18,'F'));
