...
public class LocationService {
    ...
    //method to get the locations by code size like countries, cities and departments--------------
    ...
    //method to get the locations by a code, that code is a code that the user gives to us-----------
